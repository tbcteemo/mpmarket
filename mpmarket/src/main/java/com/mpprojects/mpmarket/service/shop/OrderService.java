...
public interface OrderService extends IService<UserOrder> {
    ...
    String createOrder2(Long userid, Long couponid);
    String createOrder3(Long userid);
     ...
     */
    String createOrderRule1(Long userid,Long couponid);
    String createOrderRule2(Long userid,Long couponid);
    String createOrderRule3(Long userid,Long couponid);
    String createOrderRule4(Long userid,Long couponid);
}
