...
public class FormatController {
    ...
    @PostMapping("/add")
    public Response<ProductFormat> add(@ApiParam(type = "规格实体",required = true)
    ...
    public Response delete(@ApiParam(type = "规格id",required = true)
    ...
    @PutMapping("/put")
    public Response put(@ApiParam(type = "规格实体",required = true)
    ...
    @GetMapping("/get")
    public Response<ProductFormat> get(@ApiParam(type = "规格id",required = true)
                                           @RequestParam Long id){
