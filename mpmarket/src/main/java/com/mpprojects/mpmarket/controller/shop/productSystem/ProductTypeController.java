...
public class ProductTypeController {
    ...
    @PostMapping("/add")
    public Response<ProductType> add(@ApiParam(type = "商品类实体",required = true)
    ...
    public Response delete(@ApiParam(type = "商品类型id",required = true)
    ...
    @PutMapping("/update")
    public Response<ProductType> update(@ApiParam(type = "商品类实体",required = true)
                                            @RequestBody ProductType productType){
    ...
    @GetMapping("/getOne")
    public Response<ProductType> getOne(@ApiParam(type = "商品类型id",required = true)
                                            @RequestParam Long typeid){
    ...
    @GetMapping("/pageAll")
    public IPage<ProductType> pageAll(@ApiParam(type = "当前页",required = true)
